...
(function (root, factory) {
  ...
  protoOf(BaseOutput).r = function () {
    this.s('\n');
  };
  protoOf(BaseOutput).t = function (message) {
    this.s(message);
    this.r();
  };
  function NodeJsOutput(outputStream) {
    BaseOutput.call(this);
    this.u_1 = outputStream;
  }
  protoOf(NodeJsOutput).s = function (message) {
    // Inline function 'kotlin.io.String' call
    var messageString = String(message);
    this.u_1.write(messageString);
  };
  function BufferedOutputToConsoleLog() {
    BufferedOutput.call(this);
  }
  protoOf(BufferedOutputToConsoleLog).s = function (message) {
    // Inline function 'kotlin.io.String' call
  ...
  protoOf(BufferedOutputToConsoleLog).x = function () {
  ...
  protoOf(BufferedOutput).s = function (message) {
    var tmp = this;
    var tmp_0 = this.w_1;
    // Inline function 'kotlin.io.String' call
    tmp.w_1 = tmp_0 + String(message);
  };
  function println(message) {
    _init_properties_console_kt__rfg7jv();
    get_output().t(message);
  }
  ...
  protoOf(StringBuilder).a1 = function (value) {
  ...
  function appendElement(_this__u8e3s4, element, transform) {
    if (!(transform == null)) {
      _this__u8e3s4.a1(transform(element));
    } else {
      if (element == null ? true : isCharSequence(element)) {
        _this__u8e3s4.a1(element);
      } else {
        if (element instanceof Char) {
          _this__u8e3s4.z(element.p1_1);
        } else {
          _this__u8e3s4.a1(toString_0(element));
        }
      }
    }
  }
