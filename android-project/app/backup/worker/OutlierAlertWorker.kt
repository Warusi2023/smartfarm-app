...
class OutlierAlertWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        if (yieldOutliers.isNotEmpty() || healthOutliers.isNotEmpty()) {
            ...
            val viewIntent = Intent(context, Class.forName("com.yourcompany.smartfarm.MainActivity")).apply {
            ...
            // Review all outliers
            val reviewAllIntent = Intent(context, Class.forName("com.yourcompany.smartfarm.MainActivity")).apply {
                action = "VIEW_DASHBOARD"
                flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
