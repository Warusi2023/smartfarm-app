...
import com.example.smartfarm.data.repository.LivestockReminderRepository
...
class FakeLivestockDao(private val fakeLivestock: List<com.example.smartfarm.data.model.Livestock> = emptyList()) : com.example.smartfarm.data.database.LivestockDao {
